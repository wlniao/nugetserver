...
<body>
    <div>
        ...
        <fieldset style="width:800px">
            ...
            Package Sources:
            <blockquote>
                <strong><%= Helpers.GetRepositoryUrl(new Uri(Request.Url.Scheme + "://" + Request.Url.Host), Request.ApplicationPath) %></strong>
            </blockquote>
            ...
            <% } %>
            <blockquote>
                <strong>nuget.exe push {package file} {apikey} -Source <%= Helpers.GetPushUrl(new Uri(Request.Url.Scheme + "://" + Request.Url.Host), Request.ApplicationPath) %></strong>
            </blockquote>            
        </fieldset>
